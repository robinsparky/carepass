...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-157271171-2"></script>
	<script>
	window.dataLayer = window.dataLayer || [];
	function gtag(){dataLayer.push(arguments);}
	gtag('js', new Date());

	gtag('config', 'UA-157271171-2');
	</script>
...
<nav class="navbar navbar-default">
	<div class="container">
		...
		<div class="navbar-header">
				...
				<h1><a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="Care for Internationally Educated Nurses">
				<?php
		...
		<?php 
				...
				if($header_setting['header_social_media_enabled'] == 0 )
				{
					...
					$social .= '<li class="facebook"><a href="'.$facebook.'"';
						if( array_key_exists( 'facebook_media_enabled', $header_setting ) && $header_setting['facebook_media_enabled']==1)
						{
					...
					$social .= '<li class="twitter"><a href="'.$twitter.'"';
						if( array_key_exists( 'twitter_media_enabled', $header_setting ) && $header_setting['twitter_media_enabled']==1)
						{
						 $social .= 'target="_blank"';
						}
					...
					$social .= '<li class="linkedin"><a href="'.$linkdin.'"';
						if( array_key_exists( 'linkedin_media_enabled', $header_setting ) && $header_setting['linkedin_media_enabled']==1)
						{
						 $social .= 'target="_blank"';
						}
