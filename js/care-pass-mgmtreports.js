(function($) {
    ...
    $(document).ready(function() {       
       ...
       $('#report-select').change(function(e) {
            console.log("#report-select fired!");
       ...
       $('#pass_clear_report').on('click', function(e) {
            $('#' + care_pass_mgmt.reporttarget).html('');
       });

       $('#pass_get_report').on('click', function(e) {
            console.log("#pass_get_report fired!");
            console.log(this);
            row = $(this).closest("tr");
            startDate = row.find("input#report_start").val();
            console.log(startDate);
            endDate = row.find("input#report_end").val();
            console.log(endDate);
            ajaxFun();
       });
