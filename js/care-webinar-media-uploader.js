jQuery(document).ready( function($) {
    ...
    console.log("Care Webinar Media Uploader ... local object:");
    console.log(care_webinar_media_obj);

    let mediaUploader;
    let metaBoxId = "#" + care_webinar_media_obj.metaBoxId + ".postbox";
    let mediaInput = "#" + care_webinar_media_obj.mediaInput;
    let mediaContainerClass = care_webinar_media_obj.mediaContainer;
    let mediaType = care_webinar_media_obj.mediaType;
